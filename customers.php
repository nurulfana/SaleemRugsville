...
<head>
  ...
  <title>Saleem Rugsville System : Customers</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="cname" type="text" class="form-control" id="customerid" placeholder="Customer Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_name']; ?>" required>
            </div>
          </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="radio">
                <label>
                  <input name="cgender" type="radio" id="gender" value="Male" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Male") echo "checked"; ?> required> Male
                </label>
              </div>
              <div class="radio">
                <label>
                  <input name="cgender" type="radio" id="gender" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Female") echo "checked"; ?> required> Female
                </label>
              </div>
            </div>
          </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="cphone" type="tel" class="form-control" id="phone" pattern="\+60\d{2}-\d{7}" placeholder="+60##-#######" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phonenum']; ?>" required />
            </div>
          </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="caddress" type="text" class="form-control" id="customeraddress" placeholder="Customer Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?>" required>
            </div>
          </div>
