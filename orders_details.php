...
<head>
  ...
  <title>Saleem Rugsville System : Orders Details</title>
  <!-- Bootstrap -->
  ...
  <body>
    ...
    try {
      ...
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_a175171, tbl_staffs_a175171_pt2,
        tbl_customers_a175171_pt2 WHERE
              ...
              <div class="col-sm-9">
                <select name="pid" class="form-control" id="prd">
                  ...
                  foreach($result as $productrow) {
                    ?>
                    <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product']." ".$productrow['fld_product_name']; ?></option>
                    <?php
                  }
                  $conn = null;
                  ?>
