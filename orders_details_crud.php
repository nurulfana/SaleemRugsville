...
if (isset($_POST['addproduct'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_orders_details_a175171(fld_order_detail_num,
...
if (isset($_GET['delete'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("DELETE FROM tbl_orders_details_a175171 where fld_order_detail_num = :did");
